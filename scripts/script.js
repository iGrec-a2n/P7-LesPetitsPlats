...
const divAppareil = document.querySelector('#appliances');
const divUstensile = document.querySelector('#ustensils');
const idListIngredient = document.querySelector('#listIngredients');
const idListAppareil = document.querySelector('#listAppliances');
...
const displayListRecettes = (htmlRecettes) => {
    ...
    else section2.innerHTML = '<div id="searchFailed"><span>Aucune recette ne correspond à votre critère…<br>Vous pouvez chercher par exemple: «tarte aux pommes», «poisson», ...</span></div>';
